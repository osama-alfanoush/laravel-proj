            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="row g-3">
                    <!-- col -->
                     <div class="col-12">
                       <!-- input -->
                       <input id="emailres" type="email" class="form-control  @error('email') is-invalid @enderror;border:#21A38B" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
  ...
  <div class="row g-4 py-4">
    <div class="col-12 col-md-12 col-lg-4">
        ...
        <div class="row">
          ...
          <div class="col-6">
            <ul class="nav flex-column">
              @foreach ($categories->take(6)->skip(6) as $category)
                <li class="nav-item mb-2"><a href="#!" class="nav-link">{{ $category->name }}</a></li>
              @endforeach
            </ul>
        </div>
