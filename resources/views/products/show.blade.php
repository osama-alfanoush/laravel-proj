            ...
            <div class="col-md-6">
              <div class="slider slider-for">
                <div>
                  ...
                  style="background-image: url({{ asset('app/localimage/'.$product->image) }})">
                  <!-- img -->
                  <!-- img --><img src="{{ asset('app/localimage/'.$product->image) }}" alt="">
                </div>
                </div>
              ...
              <div class="ps-lg-10 mt-6 mt-md-0">
                ...
                <div class="mt-3 row justify-content-start g-2 align-items-center">
                  ...
                  <div class="col-xxl-4 col-lg-4 col-md-5 col-5 d-grid">
                    <!-- button -->
                    <!-- btn -->  <form action="{{ route('cart.items.store') }}" method="POST">
                        @csrf
