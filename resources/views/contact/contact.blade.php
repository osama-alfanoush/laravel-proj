          ...
          <div class="offset-lg-2 col-lg-8 col-12">
            ...
            <form class="row" method="POST" action="{{ route('contact.store') }}">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" id="fname" class="form-control" name="first_name" placeholder="Enter Your First Name" required>
              </div>
              <div class="col-md-6 mb-3">
                <!-- input -->
                <label class="form-label" for="lname"> Last Name<span class="text-danger">*</span></label>
                <input type="text" id="lname" class="form-control" name="last_name" placeholder="Enter Your Last name" required>
              </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="email" id="emailContact" name="email" class="form-control" placeholder="Enter Your First Name" required >
              </div>
              <div class="col-md-6 mb-3">
                <!-- input -->
              ...
              <div class="col-md-12 mb-3">
                ...
                <textarea rows="3" id="comments" name="commcent" class="form-control" placeholder="Additional Comments"></textarea>
              </div>
              <div class="col-md-12">
                <!-- btn -->
