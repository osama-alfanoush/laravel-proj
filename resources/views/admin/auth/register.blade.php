              ...
              <div class="row justify-content-center align-items-center">
                ...
                <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
                  <div class="mb-lg-9 mb-5">
                    ...
                    <p>Welcome to OMF! Enter your email to get started.</p>
                  </div>
                        ...
                        <div class="col-12">
                            <div class="col-12">
                              ...
                              <div class="col-12 mt-3">
                                <input id="admin_key" type="admin_key" class="form-control @error('admin_key') is-invalid @enderror" name="admin_key" value="{{ old('admin_key') }}" required autocomplete="admin_key" autofocus placeholder="admin_key">
                                @error('admin_key')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
