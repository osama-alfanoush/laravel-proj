        ...
        <nav class="navbar navbar-light py-2">
          <div class="container justify-content-center justify-content-lg-between">
            ...
            <span class="navbar-text">
              If you do not have an account?  <a href="{{ route('admin.dashboard.store') }}">Sign up</a>
            </span>
          </div>
        </nav>
      </div>
            ...
            <div class="row justify-content-center align-items-center">
              ...
              <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
                <div class="mb-lg-9 mb-5">
                  <h1 class="mb-1 h2 fw-bold">Sign in to OMF</h1>
                  <p>Welcome back to OMF! Enter your email to get started.</p>
                </div>

                <form action="{{ route('admin.dashboard.login') }}" method="post">
                   @csrf
                    <div class="row g-3">
                      <!-- row -->
                      ...
                      <div class="col-12 mb-3">
                        <!-- input -->
                        <input id="inputEmail4" type="email" placeholder="Enter email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                      ...
                      <div class="col-12">
                        <!-- input -->
                        <div class="password-field position-relative mt-3">
                            <input id="fakePassword" placeholder="Enter Password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                            ...
                            @enderror
              <span><i id="flexCheckDefault"class="bi bi-eye-slash"></i></span>
            </div>
                      ...
                      <div class="d-flex justify-content-between">
                        ...
                        <div> Forgot password?  @if (Route::has('password.request'))
                            <a  href="{{ route('password.request') }}">  {{ __('Forgot Your Password?') }}</a>    @endif</div>
                      </div>
                      <!-- btn -->
                      <div class="col-12 d-grid"> <button type="submit" class="btn btn-primary">Sign In</button>
                      </div>
                      <!-- link -->
                      <div>          {{ __('If you do not have an account ') }}           <a href="{{ route('admin.dashboard.store') }}">Sign up</a>
                      </div>
                    </div>
                  </form>
              </div>
                  ...
                  <!-- Mirrored from freshcart.codescandy.com/pages/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Sep 2023 17:08:23 GMT -->
                  </html>
