            ...
            <ul class="list-group list-group-flush">
                ...
                <div class="row align-items-center">
                  <div class="col-3 col-md-2">
                     ...
                     <img src="{{ asset('app/localimage/'.$cartItem->product->image) }}" alt="Ecommerce"
                      class="img-fluid"></div>
                      <div class="col-4 col-md-5">
                        <a href="shop-single.html" class="text-inherit"><h6 class="mb-0">{{ $cartItem->product->name }} </h6></a>
                        <span><small class="text-muted">wazen</small></span>
                      <div class="mt-2 small lh-1">  <span
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
                          ...
                          <line x1="14" y1="11" x2="14" y2="17"></line>
                            ...
                            <button type="submit" class="text-muted" style="border: 0px;  background-color: #fff;">Remove</button>
                        </form></div></div>
                  ...
                  <div class="col-3 col-md-3 col-lg-2">
                       ...
                       @method('PUT')
                        ...
                        <input type="button" name="button-minus" value="-" class="button-minus  btn  btn-sm " data-field="quantity">
                        <input type="number" step="1"  value="{{ $cartItem->quantity }}" name="quantity" class="quantity-field form-control-sm form-input">
                        <input type="button" value="+" name="button-plus" class="button-plus btn btn-sm " data-field="quantity">
                    </div>
                  ...
                  <div class="col-2 text-lg-end text-start text-md-end col-md-2">
                    <span class="fw-bold">${{ $cartItem->product->price }}</span>

                  </div>
                </div>

                <div class="d-flex justify-content-between  mb-1" style="margin-left: 700px">
            ...
            <div class="card-body p-6">
              ...
              <div class="d-grid mb-1 mt-4">
                ...
                <button class="btn btn-primary btn-lg d-flex justify-content-between align-items-center" type="submit">
                  Go to Checkout <span class="fw-bold">${{ $total }}</span></button>
              </div>
            </form>
              <!-- text -->
...
$(document).ready(function() {
    $('.button-minus').click(function() {
        var quantityField = $(this).data('field');
...
<!-- Mirrored from freshcart.codescandy.com/pages/shop-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Sep 2023 17:07:40 GMT -->
</html>
